...
def InitSidebar():
    ...
    st.sidebar.caption("Version 0.2.5")
    ...
    st.sidebar.page_link("pages/fflagsoptima.py", label=LANG["lution.tab.fflagsopit"], icon="⚡")
    ...
    st.sidebar.caption(f"Running commit : {GIT_COMMIT}")
